void main() {
  ...
  checkBalance(name: "Daulet", balance: balance);
  balance = deposit(balance, 500.0);

  checkBalance(name: "Daulet", balance: balance);
  balance = withdraw("Daulet", balance, 200.0, 1234);

  checkBalance(name: "Daulet", balance: balance);
  balance = withdraw("Daulet", balance, 2000.0, 1235);

  checkBalance(name: "Daulet", balance: balance);
  balance -= withdraw("Daulet", balance, 20000.0, 1234);
